/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 98ba43eab54fb550d4d7a8071606d477)
...
interface __BaseEnv_Env {
	...
	ASSETS: Fetcher;
	SITE_NAME: "Thai Massage For U";
	SITE_URL: "https://thaimassageforu.com";
	CONTACT_EMAIL: "hello@thaimassageforu.com";
	FORM_LIMITER: DurableObjectNamespace<import("./src/index").FormLimiter>;
	OFFER_WORKFLOW: Workflow<Parameters<import("./src/index").SaleOfferWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "FormLimiter";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SITE_NAME" | "SITE_URL" | "CONTACT_EMAIL">> {}
}
