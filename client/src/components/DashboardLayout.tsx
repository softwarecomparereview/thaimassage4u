...
import { Building2, FileText, Inbox, Languages, LayoutDashboard, LogOut, Map, MessageCircleMore, PanelLeft, Radar, Send, Wand2, ShoppingBag } from "lucide-react";
...
const menuItems = [
  ...
  { icon: Building2, label: "Listings", path: "/cms/listings" },
  { icon: Map, label: "City desk", path: "/cms/cities" },
  { icon: FileText, label: "Journal", path: "/cms/content" },
  ...
  { icon: ShoppingBag, label: "Supplies", path: "/cms/supplies" },
