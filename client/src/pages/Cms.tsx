...
export default function Cms() {
  ...
  return <DashboardLayout><div className="cms-workspace">
    ...
    {data && <>
      ...
      {section === "cities" && <CmsCities cityForm={cityForm} setCityForm={setCityForm} submit={submitCity} saving={saveCity.isPending} cities={data.cities} />}
