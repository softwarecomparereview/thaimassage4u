...
import { ArrowDownRight, ArrowUpRight, CalendarDays, Compass, KeyRound, MapPin, Search, Sparkles } from "lucide-react";
...
export default function Home() {
  ...
  return <><SiteHeader /><main>
    ...
    <section className="claim-cta"><KeyRound size={22} /><div><h2>See your business here?</h2><p>Claim your listing to keep it up to date — no account to set up, just a one-time code to the contact details already on file.</p></div><Link href="/claim" className="dark-button">Claim your listing <ArrowUpRight size={16} /></Link></section>
